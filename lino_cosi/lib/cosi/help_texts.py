...
period, and also its "state": whether it is "closed" or not."""),
    ...
    'lino_cosi.lib.ledger.models.PaymentTerm.days' : _("""Number of days to add to voucher_date."""),
    'lino_cosi.lib.ledger.models.PaymentTerm.months' : _("""Number of months to add to voucher_date."""),
    'lino_cosi.lib.ledger.models.PaymentTerm.end_of_month' : _("""Whether to move voucher_date to the end of month."""),
    'lino_cosi.lib.ledger.models.PaymentTerm.printed_text' : _("""Used in sales/VatProductInvoice/trailer.html as
follows:"""),
...
this journal entry."""),
    'lino_cosi.lib.ledger.models.Voucher.currency' : _("""This is currently used only in some print templates."""),
...
be cleared using a given journal."""),
    ...
    'lino_cosi.lib.ledger.roles.VoucherSupervisor' : _("""Somebody who can edit vouchers which have been written by other
users."""),
