...
(VatDocument) and for each item (VatItemBase)."""),
    ...
    'lino_cosi.lib.courses.models.Line.name' : _("""The designation of this course series as seen by the user
...
import_statements_path."""),
    'lino_cosi.lib.courses.ui.Courses' : _("""Base table for all courses."""),
...
it."""),
    'lino_cosi.projects.std.settings.Site' : _("""Base class for a Lino Così application."""),
...
layout's main element."""),
    'lino_cosi.lib.courses.models.Line.body_template' : _("""The body template to use when printing a course of this
...
value date."""),
    'lino_cosi.lib.courses.models.Line' : _("""A line (or series) of courses groups courses into a
...
having that match."""),
    ...
    'lino_cosi.lib.courses.ui.Courses.model' : _("""alias of Course"""),
